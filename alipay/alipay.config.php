...
//获取支付账号信息
$sql="select * from set_pay_info where ttedu_id=1";
...
$aliapy_config['partner']      = $pay['ttedu_hezuoshengfenid'];

//安全检验码，以数字和字母组成的32位字符
$aliapy_config['key']          = $pay['ttedu_anquanyangzhengma'];

//签约支付宝账号或卖家支付宝帐户
$aliapy_config['seller_email'] = $pay['ttedu_zhanghao'];

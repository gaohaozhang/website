...
<div class="main mainbg clearfix">
	<div class=PleftM>
		<div class=rcur>
			<p>
				<strong>当前位置：</strong><a href="__APP__/index/index">首页</a>&gt; <strong>教学视频</strong>
			</p>
		</div>
		<div class=tit01>
			<div class=Ptit01T1>
				<img src="Public/images/d10.gif">
				<h2><strong>教学视频列表</strong></h2>
			</div>
			<table border=0 cellspacing=0 cellpadding=0 width="650" align=center>
				...
				<tr>
					<td class=WordRed80S width="650" align=middle>
						－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－
					</td>
				</tr>
				</tbody>
			</table>
			<table class=BGWhite border=0 cellspacing=1 cellpadding=0 width="650" align=center>
				<tbody>
				<?php if(is_array($spinfo_detail)): $i = 0; $__LIST__ = $spinfo_detail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 4 )?><?php if(($mod)  ==  "1"): ?><tr class=BGBlue10 height=180><?php endif; ?>
					<td align=middle>
						<a href="__URL__/videodetail/ttedu_id/<?php echo ($vo["ttedu_id"]); ?>/jishu/0" target=_blank><img border=0 alt="<?php echo ($vo["ttedu_sptitle"]); ?>[<?php echo ($vo["ttedu_spjishu"]); ?>集]" src="__PUBLIC__/Uploads/<?php echo ($vo["ttedu_sppic"]); ?>" width="126" height="94"></a><br>
						<a href="__URL__/videodetail/ttedu_id/<?php echo ($vo["ttedu_id"]); ?>" target=_blank><font color=#006600><?php echo ($vo["ttedu_sptitle"]); ?><br>
							[<?php echo ($vo["ttedu_spjishu"]); ?>集]</font></a>
					</td>
					<?php if(($mod)  ==  "4"): ?></tr><?php endif; ?><?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
			</table>
			<div class=num>
				<?php echo ($page); ?>

...
<div class="main mainbg clearfix">
	<div class=PleftM>
		<div class=rcur>
			<p>
				<strong>当前位置：</strong><a href="http://www.eduease.com/">首页</a>&gt; <strong>教学视频</strong>
			</p>
		</div>
		<div class=tit01>
			<div class=Ptit01T1>
			...
			<table class=BGWhite border=0 cellspacing=0 cellpadding=0 width="100%" align=center>
				...
				<tr>
					<td colspan=2 align=middle>
						<span style="font-size:14px; color:#006600"><?php echo ($spinfo_detail["ttedu_sptitle"]); ?></span>
						<hr width="95%">
					</td>
				</tr>
				<tr>
					<td class=BGWhite valign=top width="100%" align=center>
						<br>
						<?php if(is_array($shiping_jishu)): $i = 0; $__LIST__ = $shiping_jishu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><a href="__URL__/videodetail/ttedu_id/<?php echo ($spinfo_detail["ttedu_id"]); ?>/jishu/<?php echo ($vo["ttedu_id"]); ?>">
								<?php if(($vo["ttedu_id"])  ==  $jishu): ?><font color=#ff0000><?php echo ($vo["ttedu_jishu"]); ?></font></a>&nbsp;&nbsp; <?php else: ?>
				...
				<tr>
					<td class=BGWhite valign=top width="100%" align=left>
						<br>
				...
				<tr>
					<td colspan=2 align=middle>
						<br>
						<input class=SmallButton onclick=window.close() value=关闭窗口 type=button><br>
						<br>
						视频版权归原作者所有，未经允许请勿转载，如有任何问题请联系我们。
						<hr width="95%">
						<br>
						<br>
					</td>

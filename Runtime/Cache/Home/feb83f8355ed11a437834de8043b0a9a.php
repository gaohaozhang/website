...
<div class="main mainbg clearfix">
	<div class=PleftM>
		<div class=rcur>
			<p>
				<strong>当前位置：</strong><a href="__APP__/index/index">首页</a>&gt;<strong>资料下载列表</strong>
			</p>
		</div>
		<div class=tit01>
			<div class=Ptit01T1>
				<img src="Public/images/d10.gif">
				<h2><strong>资料下载列表</strong></h2>
			</div>
			<table border=0 cellspacing=0 cellpadding=0 width="100%" align=center>
				...
				<tr class=BGWhite valign=top>
					<td align=middle>
						<?php if(is_array($btype_down)): $i = 0; $__LIST__ = $btype_down;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?>&nbsp; <a href="__URL__/downloadlist/ttedu_btype_id/<?php echo ($vo["ttedu_id"]); ?>" style="color:#006600;">
							<?php if(($vo["ttedu_id"])  ==  $ttedu_btype_id): ?><font color="#FF0000"><?php echo ($vo["ttedu_btype_name"]); ?></font><?php else: ?><?php echo ($vo["ttedu_btype_name"]); ?><?php endif; ?></a>&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
					</td>
				</tr>
				<tr>
			...
			<ol class=Pline02>
				<?php if(is_array($info_down)): $i = 0; $__LIST__ = $info_down;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li><span class=green>-<?php echo (date('Y-m-d',$vo["ttedu_sgdate"])); ?>-</span><a href="__URL__/downloaddetail/ttedu_id/<?php echo ($vo["ttedu_id"]); ?>" target=_blank><?php echo ($vo["ttedu_title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ol>
			<br>
			<div class=num>
				<?php echo ($page); ?>

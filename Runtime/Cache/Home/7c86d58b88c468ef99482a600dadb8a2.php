...
<div class="main mainbg clearfix">
  <div class=PleftM>
    <div class=rcur>
      <p>
        <strong>当前位置：</strong>
        <a href="__APP__/index/index">首页</a>&gt; <a href="__APP__/InfoDetail/infolist/ttedu_id/<?php echo ($btype_info["ttedu_id"]); ?>"><?php echo ($btype_info["ttedu_btype_name"]); ?></a> &gt; <strong><?php echo ($info_detail["ttedu_title"]); ?></strong>
      </p>
    </div>
    <div class=tit01>
      <div id=cont style="height:470px;">
        <h1><?php echo ($info_detail["ttedu_title"]); ?></h1>
        <p>
          <?php echo ($info_detail["ttedu_content"]); ?>
        </p>
        <div class=hackbox>
        </div>
      </div>
      <div class=tit01>
        ...
        <ol style="WIDTH: 80%" class="line01 fl">
          <?php if(is_array($info_detail_other)): $i = 0; $__LIST__ = $info_detail_other;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li><a href="__APP__/InfoDetail/infodetail/ttedu_id/<?php echo ($vo["ttedu_id"]); ?>" target=_blank><?php echo ($vo["ttedu_title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ol>
        <div class=hackbox>
        </div>
      </div>
